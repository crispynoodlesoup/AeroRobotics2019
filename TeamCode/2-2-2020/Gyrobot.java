...
public class Gyrobot extends LinearOpMode {
    ...
    private DcMotor liftBlock   = null;
    private DcMotor lift        = null;
    private Servo   servoArm    = null;
    private Servo   servoGrab1  = null;
    private Servo   servoGrab2  = null;
    private Servo   servoTray1  = null;
    private Servo   servoTray2  = null;
    ...
    private boolean toggleTray = false;
    private boolean grabPrev;
    private boolean trayPrev;
    ...
    public void runOpMode() {
        ...
        liftBlock   = hardwareMap.get(DcMotor.class, "liftBlock");
        lift        = hardwareMap.get(DcMotor.class, "lift");
        servoArm    = hardwareMap.get(Servo.class,   "servoArm");
        servoTray1  = hardwareMap.get(Servo.class,   "servoTray1");
        servoTray2  = hardwareMap.get(Servo.class,   "servoTray2");
        ...
        liftBlock.setMode(DcMotor.RunMode.RUN_USING_ENCODER);
        ...
        liftBlock.setZeroPowerBehavior(DcMotor.ZeroPowerBehavior.BRAKE);
        ...
        while (opModeIsActive()) {
            ...
            lift(gamepad2.dpad_right, gamepad2.dpad_left);
            liftBlock(gamepad2.dpad_up, gamepad2.dpad_down);
            ...
            telemetry.addData("lift: ", liftBlock.getCurrentPosition());
            telemetry.update();
        }
    }
    ...
    public void liftBlock(boolean up, boolean down) {
        liftBlock.setMode(DcMotor.RunMode.RUN_USING_ENCODER);
        if(up && !down) {
            liftBlock.setPower(1);
            //while(lift.isBusy()){}
        }
        else if(down && !up) {
            liftBlock.setPower(-1);
    ...
    public void liftPos(int pos) {
        liftBlock.setTargetPosition(pos);
        liftBlock.setMode(DcMotor.RunMode.RUN_TO_POSITION);
        liftBlock.setPower(1);
    }
